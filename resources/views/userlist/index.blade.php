                ...
                <div class="col-md-4 col-sm-12 mb-4"> 
                    <div class="card shadow h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title mt-3">{{ $adminCount }}</h5>
                            <!-- link admin show blade  -->
                            <p class="card-text"> <a href="{{ route('admin.index') }}"> Admin </a> </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12 mb-4">
                    <div class="card shadow h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title mt-3">{{ $branchstaffCount }}</h5>
                            <!-- link branchstaff show blade  -->
                            <p class="card-text"> <a href="{{ route('branchstaff.index') }}" > Branch Staff </a> </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12 mb-4">
                    <div class="card shadow h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title mt-3">{{ $instructorCount }}</h5>
                            <!-- link instructor show blade  -->
                            <p class="card-text"> <a href="{{ route('instructor.index') }}"> Instructor </a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12 mb-4">
                    <div class="card shadow h-100">
                        <div class="card-body text-center">
                            ...
                            <h5 class="card-title mt-3">{{ $studentCount }}</h5>
                            <!-- link student show blade  -->
                            <p class="card-text"> <a href="{{ route('student.index') }}"> Student </a></p>
                        </div>
                    </div>
                </div>
            </div>
